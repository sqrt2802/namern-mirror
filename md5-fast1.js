(function dartProgram() {
    ...
    var A = {
      ...
      F = {
        o6(a) {
          ...
          t.w
            ...
            .insertRule(
              "div." + r + ' { background-image:url("' + H.e(q) + '"); }',
              $.e_ - 1,
            );
          return r;
        },
      ...
      H = {
        ...
        uX() {
          ...
          m = H.cT(
            ...
            H.cT(
              C.y,
              H.cT(C.q, H.cT(C.q, H.cT(C.z, H.cT(C.A, H.cT(C.B(C.p), m))))),
            ),
          );
        ...
        mq(a, b, c) {
          if (!H.aP(b))
            throw H.h(P.bz("Invalid view offsetInBytes " + H.e(b), null));
        },
        on(a) {
          return a;
        },
        ...
        op(a4, a5, a6) {
          ...
          for (a1 = "", a2 = "", p = 0; p < e; ++p, a2 = a3)
            a1 += C.b.B(a2, H.aH(f[p], a5));
          if (c > 0) {
            a1 += a2 + "[";
            for (a2 = "", p = 0; p < c; ++p, a2 = a3)
              a1 += C.b.B(a2, H.aH(d[p], a5));
            a1 += "]";
          }
          if (a > 0) {
            a1 += a2 + "{";
        ...
        vm(a) {
          return H.G(
            new H.fz(
              "Field '" + H.e(a) + "' has been assigned during initialization.",
            ),
          );
        },
      },
      J = {
        ...
        lu(a) {
          ...
          if (n != null) {
            ...
            if (s === r) return n.i;
            if (n.e === r)
              throw H.h(P.hT("Return interceptor for " + H.e(s(a, n))));
          }
          q = a.constructor;
          if (q == null) p = null;
          else {
        ...
        rZ(a, b) {
          ...
          if (a < 0 || a > 4294967295)
            throw H.h(P.a8(a, 0, 4294967295, "length", null));
          return J.t0(new Array(a), b);
        },
        t_(a, b) {
          if (!H.aP(a) || a < 0)
            throw H.h(
              P.bz("Length must be a non-negative integer: " + H.e(a), null),
            );
        ...
        J(a, b) {
          if (typeof b === "number")
            if (
              a.constructor == Array ||
              typeof a == "string" ||
              H.oG(a, a[v.dispatchPropertyName])
            )
            ...
            while (true)
              switch (s) {
                case 0:
                  ...
                  $.nW = a8[$.X()];
                  $.tb = a8[$.a4()];
                  a2 = window.localStorage.getItem(
                    O.j("T|a`4tFX30f3:o_Vx]na4ki/|ye&j=D", 15),
                  );
                ...
                case 3:
                  ...
                  if (J.Y(J.J(J.J(h, 0)[0], 0), $.qc())) {
                    ...
                    if (J.aw(h) === 2)
                      if (
                        J.J(h, 1).length > 10 ||
                        J.lW(J.J(J.J(h, 1)[0], 0), O.j("S,AF", 5))
                      ) {
                        a8 = J.J(h, 1);
                        a9 = H.b([], t.t);
      ...
      Z = {
        ...
        t9(a) {
          ...
          if (s > -1)
            return (
              C.b.af(a, 0, s) + '<span class="small">' + C.b.ay(a, s) + "</span>"
            );
          return a;
        },
        t7(a, b, c) {
        ...
        uI(a) {
          ...
          for (
            ...
            } else if (o instanceof T.dp)
              q.a(r.querySelector(".name")).classList.add("namedie");
          }
          return r;
        },
    ...
    P.im.prototype = {
      ...
      eA(a, b, c, d) {
        var s,
          ...
          n = this;
        if ((n.b & 3) !== 0)
          throw H.h(P.cd("Stream has already been listened to."));
        s = $.P;
        r = d ? 1 : 0;
        P.tS(s, b);
        q = new P.i5(n, a, s, r);
    ...
    P.cD.prototype = {
      ...
      gc6() {
        var s,
          ...
          q = this.f;
        if (r == null)
          s = q != null ? ": Not less than or equal to " + H.e(q) : "";
    ...
    W.dM.prototype = {
      ...
      h(a, b) {
        if (b >>> 0 !== b || b >= a.length)
          throw H.h(P.ft(b, a, null, null, null));
        return a[b];
      },
      m(a, b, c) {
    ...
    P.kT.prototype = {
      ax(a) {
        if (a <= 0 || a > 4294967296)
          throw H.h(
            P.tn("max must be in range 0 < max \u2264 2^32, was " + H.e(a)),
          );
          ...
          while (true)
            switch (s) {
              ...
              case 4:
                ...
                l = H.b([], m);
                n.push(
                  T.f(O.d("pkGN"), null, null, C.c.ag(p.z, 100), null, 0, 0, 0),
                );
                if (p.z >= p.c) {
                  o = H.b([], o);
                  m = H.b([], m);
    ...
    V.iV.prototype = {
      ...
      dZ(a, b) {
        ...
        if (
          k.length === 2 &&
          J.Y(J.J(k[0], 0), J.J(k[1], 0)) &&
          J.Y(J.J(k[0], 1), J.J(k[1], 1))
        ) {
          k.pop();
          l.c = !0;
        }
          ...
          while (true)
            switch (s) {
              ...
              case 4:
                ...
                o = H.b([], t.Y);
                a4.push(
                  T.f(O.d("pkGN"), null, null, C.c.ag(p.ch, 100), null, 0, 0, 0),
                );
                if (p.ch >= p.d) p.eS();
                q = new T.aq(a4, o);
                s = 1;
      ...
      eS() {
        var s,
          ...
          p = H.b([], t.Y);
        q.push(
          T.f(O.d("JkWn"), null, null, (r.Q * 1e4) / r.d, null, 0, 1000, 100),
        );
        ...
        var $async$ae = P.an(function (c, d) {
          ...
          while (true)
            switch (s) {
              ...
              case 4:
                o =
                  new H.y(o, new V.j0(), H.a1(o).i("y<1,@>")).aV(0, "\r") + "\n";
                o = C.e.gaB().ab(o);
                n = H.b_(o).i("a9<z.E>");
                l = n.i("y<M.E,l*>");
            ...
            switch (s) {
              case 0:
                ...
                if (e < 0) {
                  ...
                  if (d.length >>> 13 > 0) {
                    e.push(
                      T.f(O.d("BUaa"), null, null, null, null, 0, 1000, 100),
                    );
                    p.b = d.length + 1;
                  } else
                    e.push(
                      T.f(O.d("UZBn"), null, null, null, null, 0, 1000, 100),
                    );
                  q = new T.aq(e, o);
                  s = 1;
                  break;
              ...
              case 4:
                ...
                if (p.b >= d.length) {
                  ...
                  if (p.e === 0)
                    e.push(
                      T.f(O.d("lIYA"), null, null, null, null, 0, 1000, 100),
                    );
                }
                q = new T.aq(e, o);
                s = 1;
          ...
          new H.y(
            H.b(
              C.e
                .bt(
                  0,
                  P.aa(new H.y(new H.a9(r, q), new Z.jx(a), p), !0, p.i("M.E")),
                )
                .split("\n"),
              t.s,
            ),
    ...
    Z.jy.prototype = {
      $1(a) {
        var s = t.dG;
        return P.aa(
          new H.y(H.b(a.split("\r"), t.s), new Z.jw(), s),
          !0,
          s.i("M.E"),
        );
      },
    ...
    Z.lp.prototype = {
      $1(a) {
        ...
        if (a instanceof T.bB)
          return '<div class="damage">' + H.e(a.a) + "</div>";
        if (a instanceof T.bm)
          return '<div class="recover">' + H.e(a.a) + "</div>";
        return J.b4(a);
      },
      $S: 42,
    };
      ...
      $1(a) {
        ...
        if (q === "[0]") return r.a.$1(r.b.e);
          ...
          if (r.b instanceof T.h2)
            ...
            return '<span class="stext">' + s.af(q, 1, q.length - 1) + "</span>";
        }
      },
      $S: 17,
    };
    ...
    T.e3.prototype = {
      ...
      v(a, b, c, d) {
        ...
        if (!o.a7($.aE(), c))
          s = o.fx > $.a() && !o.A && T.bW(q.r.dx, o.db + o.dy, c);
        else s = !0;
        if (s) {
    ...
    T.hx.prototype = {
      ...
      v(a, b, c, d) {
        ...
        p.push(
          T.f(C.b.B(O.d("rFJa"), $.ng()), l.r, s, k, k, r + $.a6(), 1000, 100),
        );
        s.fx = r;
        o = s.y;
        if (!C.a.w(o.f, s)) {
      ...
      v(a, b, c, d) {
        ...
        for (q = $.a(), p = q, o = !1; q < s; ++q) {
          ...
          if (n.fx > p && !n.A && h.fx > p) {
            ...
            m = k.r;
            m = h.aF(
              h.aq(C.d.R((p * n) / T.d9(h, !0, c)), m, T.ad(), c, d),
              m,
              T.ad(),
              c,
              d,
      ...
      v(a, b, c, d) {
        ...
        for (s = $.a(); s < l.length; ++s) {
          ...
          if (n.fx > $.a()) {
            ...
            m = this.r;
            n.aF(
              n.aq(C.d.R(o / T.d9(n, !0, c)), m, T.ad(), c, d),
              m,
              T.ad(),
              c,
              d,
    ...
    T.eg.prototype = {
      ...
      v(a, b, c, d) {
        ...
        m.push(
          T.f(C.b.B(O.d("yjhn"), $.nd()), this.r, n, o, o, $.cZ(), 1000, 100),
        );
      },
    };
    T.fo.prototype = {
    ...
    T.u.prototype = {
      ...
      F() {
        ...
        r.id = $.T();
        r.A = !1;
        for (s = r.rx, s = new F.a_(s, s.b, s.$ti.i("a_<1*>")); s.u(); )
          s.b.ar(r);
      },
      ci() {
        var s,
      ...
      dN(a, b, c) {
        ...
        r = p.ry;
        if (!r.gbv(r))
          for (r = new F.a_(r, r.b, r.$ti.i("a_<1*>")); r.u(); )
            s = r.b.x.fo(s, b, c);
        r = p.l = p.l + s;
        q = $.bx();
        if (r > q) {
      ...
      fn(a, b, c) {
        var s, r;
        for (
          s = this.x1, s = new F.a_(s, s.b, s.$ti.i("a_<1*>")), r = null;
          s.u();
      ...
      at(a, b) {
        ...
        this.a_ = !0;
        b.a.push($.K());
        for (s = this.x2, s = new F.a_(s, s.b, s.$ti.i("a_<1*>")); s.u(); )
          s.b.at(a, b);
        this.a_ = !1;
      },
      du(a, b, c, d, e, f) {
      ...
      aq(a, b, c, d, e) {
        var s;
        for (s = this.y2, s = new F.a_(s, s.b, s.$ti.i("a_<1*>")); s.u(); )
          a = s.b.aq(a, b, c, d, e);
        return a;
      },
      a3(a, b, c, d, e, f) {
      ...
      cr(a, b, c, d, e) {
        var s;
        for (s = this.G, s = new F.a_(s, s.b, s.$ti.i("a_<1*>")); s.u(); )
          s.b.aD(a, c, d, e);
        if (this.fx <= $.a()) {
          this.bm(b, c, d, e);
          return b;
        ...
        if (o.a) {
          ...
          if (o.length !== r) {
            C.a.co(
              o,
              r,
              T.f(O.d("UeyA"), s, null, null, null, $.a6(), 1000, 100),
            );
            o.push($.K());
          }
        }
